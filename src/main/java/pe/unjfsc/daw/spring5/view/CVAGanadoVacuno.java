...
private static final Logger log = LoggerFactory.getLogger("CVIGanadoVacuno");
	...
	public static void main(String[] args) {
		...
		log.info("Todos los registros: {}", oCMAGanadoVacuno.consultaAll());
		...
		log.info("Verificar último registro: {}",oCMAGanadoVacuno.consultaAll());
		
		//Eliminamos un registro por su cuia
		oCMAGanadoVacuno.deleteGanadoVacuno(2001);
		
		//Verificamos si se eliminó
		log.info("Verificar la eliminación: {}",oCMAGanadoVacuno.consultaAll());
